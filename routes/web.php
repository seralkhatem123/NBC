...
/* Route::get('/', function () {
    ...
    //     return view('errorborowsername')->middleware('auth');
    // }); 
    // Route::any('borowsername3',function(){
    //     return view('borowsername3')->middleware('auth');
    // }); 
    // Route::any('borowsername',function(){
    //     return view('borowsername')->middleware('auth');
    // }); 
    // Route::any('borowsername2',function(){
    //     return view('borowsername2')->middleware('auth');
    // });
    // Route::any('announcement',function(){
    //     return view('pages.announcement')->middleware('auth');
    // });
    Route::get('/rossross',function(){
...
Route::get('insertvideoparts', function(){
    ...
    Route::get('/check', 'UserController@userOnlineStatus')->middleware('auth');
    ...
    Route::any('deleteattemp/{id}',function(Request $request,$id){
     ...
     //   DB::table('ref_result')->where('id',$id)->update(['pass' =>'In progress']);
       ...
       return redirect('allbookmarks')->middleware('auth');
        return view('map.home')->middleware('auth');
  ...
  //      DB::table('ref_result')->where('id',$id)->delete();
    ...
    Route::any('allusers',function(Request $request){
        return view('ross.allusers')->middleware('auth');
    
    });    
    Route::any('timersubmit',function(Request $request){
        return view('exam.timersubmit')->middleware('auth');
    ...
    Route::any('comments',function(Request $request){
        $comments = DB::table('comments')->get();
            return view('ross.comments',compact('comments'))->middleware('auth');
...
Route::any('createfeeq',function(Request $request){
    ...
    return view('exam.feesq',compact('explain_fee','student_id'))->middleware('auth');
...
Route::any('insertexplainfee',function(Request $request){
    ...
    $explain_fee = DB::table('explains')->where('student_id',$student_id)->orderBy('subject_id')->get();
    return view('exam.feesq',compact('explain_fee','student_id'))->with('Success','Successfully..!')->middleware('auth');
...
Route::get('addexam123',function(){
    $exams = DB::table('exam')->where('examtitle','!=','Empty')->get();
    return view('pems.addexam',compact('exams'))->middleware('auth');
});/*
...
Route::get('import_excell','BasicController@comments')->middleware('auth');
Route::post('import_excell/import','BasicController@import')->middleware('auth');
Route::get('export', 'BasicController@export')->name('export')->middleware('auth');
Route::get('importExportView', 'BasicController@importExportView')->middleware('auth');
Route::post('import', 'BasicController@import')->name('import')->middleware('auth');
...
Route::get('/resetpass', function(){  return view('pages/passwordrequest'); });
...
//---------------------------------------------------------------------------------------------------------*/
Route::get('/allinvoicepayment',function(){     return view ('ross.allinvoicepayment');})->middleware('auth');
Route::get('/deleteinvoice/{id}',function($id){ Invoice::find($id)->delete();     return   redirect('/allinvoicepayment');})->middleware('auth');
Route::get('/deletepayment/{id}',function($id){  Payment::find($id)->delete();     return redirect('/allinvoicepayment');})->middleware('auth');
Route::get('/deleteexampt/{id}',function($id){  Ref_result::find($id)->delete();     return redirect('/allinvoicepayment');})->middleware('auth');
...
Route::get('/ross', 'RossesController@ross')->name('ross');//->middleware('auth')
Route::get('/admin/home1', 'RossesController@ross')->name('ross');

Route::get('/proctor', 'RossesController@proctor')->name('proctor')->middleware('auth');
Route::any('/showmembers','RossesController@showmembers')->middleware('auth');
Route::any('/members','RossesController@members')->middleware('auth');
Route::any('/receipts2','RossesController@receipts2')->middleware('auth');
Route::any('/receipts','RossesController@receipts')->middleware('auth');
Route::any('/showreceipts','RossesController@showreceipts')->middleware('auth');
Route::any('/registerations','RossesController@registerations')->middleware('auth');
Route::any('/profiles','RossesController@profiles')->middleware('auth');
Route::any('/bookmarks','RossesController@profiles')->middleware('auth');
...
//Route::any('/proctorq','RossesController@proctorq')->middleware('auth');
Route::any('/proctorq','RossesController@proctorq1')->middleware('auth');
Route::any('/receiptsq/{id}','RossesController@receiptsq')->name('/receiptsq/{id}')->middleware('auth');
Route::any('/ross/showprofile/{id}','RossesController@showprofile')->name('/ross/showprofile/{id}')->middleware('auth');
Route::any('/ross/membersq/{id}','RossesController@showmembersq')->name('/ross/membersq/{id}')->middleware('auth');
Route::any('/ross/membersqid/{id}','RossesController@membersqid')->name('/ross/membersq/{id}')->middleware('auth');
Route::post('/savenewphone2', 'RossesController@savenewphone')->name('/savenewphone2')->middleware('auth');
Route::get('/savenewphone', 'RossesController@getsavenewphone')->name('/savenewphone')->middleware('auth');
Route::post('/savenewemail2', 'RossesController@savenewemail')->name('/savenewemail2')->middleware('auth');
Route::get('/savenewemail', 'RossesController@getsavenewemail')->name('/savenewemail')->middleware('auth');
Route::any('/exambookingsystemq', 'RossesController@exambookingsystemq')->name('/exambookingsystemq')->middleware('auth');
Route::post('/bookdate', 'RossesController@exambookingsystemdate')->name('/bookdate')->middleware('auth');
Route::any('/openexam/{id}', 'RossesController@openexam')->name('/openexam/{id}')->middleware('auth');
Route::any('ross/Proctor/date', 'RossesController@openexam')->name('ross/Proctor/date')->middleware('auth');


//Route::post('/exemptselect', 'RossesController@exemptselect')->name('/exemptselect')->middleware('auth');
//Route::post('/undoexempt', 'RossesController@undoexempt')->name('/undoexempt')->middleware('auth'); 
Route::get('/undoexempt/{id}', 'RossesController@undoexemptid')->name('/undoexempt/{id}')->middleware('auth'); 
Route::get('/selectexempt/{id}/{student_id}', 'RossesController@selectexempt')->name('/selectexempt/{id}/{student_id}')->middleware('auth');
//--------------------Update Users Status --------------------------------------------------------------------------------------------
Route::any('/takescholarship', 'RossesController@takescholarship')->name('takescholarship')->middleware('auth');
Route::post('/receiptsq1', 'RossesController@receiptsq1')->name('receiptsq1')->middleware('auth');
Route::any('/receiptsq', 'RossesController@receiptsq')->name('receiptsq')->middleware('auth');
//------------------------------------------------------------------------------------------------------------------------------------
Route::post('/insertPay1', 'RossesController@insertPay1')->middleware('auth');
Route::post('/proctordate', 'RossesController@proctordate')->name('proctordate')->middleware('auth');
...
Route::post('/employees/getEmployees/','EmployeesController@getEmployees')->name('employees.getEmployees')->middleware('auth');
Route::post('/employees','EmployeesController@employees2')->middleware('auth');
Route::post('/employees2','EmployeesController@employees2')->middleware('auth');

//--------------------------XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX--------------------------------------------------------------------------------
Route::get('session/get','SessionController@accessSessionData');
Route::get('session/set','SessionController@storeSessionData');
Route::get('session/remove','SessionController@deleteSessionData');
Route::get('allinvoice','MapController@allinvoice')->middleware('auth');
Route::get('allpayment','MapController@allpayment')->middleware('auth');
//------------------------------------PEMS-----------------------------------------------------------------------------------------------
Route::get('pems/home','PemsController@home')->middleware('auth');
Route::get('pems','PemsController@home')->name('pems')->middleware('auth');

Route::any('pems/addadmin','PemsController@addadmin')->middleware('auth');
Route::any('/pems/deleteadmin','PemsController@deleteadmin')->middleware('auth');
Route::any('/pems/editadmin','PemsController@editadmin')->middleware('auth');
Route::any('/pems/posteditadmin','PemsController@posteditadmin')->middleware('auth');
Route::get('pems/','PemsController@home')->middleware('auth');
Route::get('pems/certificate','PemsController@certificate')->middleware('auth');
Route::any('pems/certificateq','PemsController@certificateq')->middleware('auth');
Route::any('pems/updateexamresult','PemsController@updateexamresult')->middleware('auth');
Route::get('pems/certificate2','PemsController@certificate2')->middleware('auth');
Route::get('pems/exams','PemsController@exams')->middleware('auth');
Route::get('pems/startexam','PemsController@startexam')->middleware('auth');
Route::post('/pems/examsedit','PemsController@examsedit')->name('/pems/examedit')->middleware('auth');
Route::get('/examsedit/{examcode}','PemsController@examsedit')->name('/examedit/{examcode}')->middleware('auth'); 
Route::post('/examsedit2/{examcode}','PemsController@examsedit2')->name('/examsedit2/{examcode}')->middleware('auth'); 
Route::any('/examQedit/{examcode}','PemsController@examQedit')->name('/examsedit2/{examcode}')->middleware('auth'); 
Route::any('/exameditquestion/{examcode}','PemsController@exameditquestion')->name('/exameditquestion/{examcode}')->middleware('auth'); 
Route::post('/exameditquestionoffline/{examcode}','PemsController@exameditquestionoffline')->name('/exameditquestionoffline/{examcode}')->middleware('auth'); 
//-----------------------------------Add New Question ---------------------------------------------------------------------------------------//
Route::any('/pems/addnewquestion1',function(Request $request)
    { $examcode = $request->examcode;    
        return view('pems.addnewquestion1',compact('examcode'));})->middleware('auth');
 
//-----------------------------------------------------------------------------------------------------------------------------------------//
Route::post('/addnewquestion/{examcode}','PemsController@addnewquestion1')->name('/addnewquestion/{examcode}')->middleware('auth'); 
Route::post('/addnewquestion2','PemsController@addnewquestion2')->name('/addnewquestion2')->middleware('auth'); 
Route::post('/addnewquestionoffline/{examcode}','PemsController@addnewquestionoffline')->name('/addnewquestionoffline/{examcode}')->middleware('auth'); 
Route::post('/findresult','PemsController@findresult')->name('/findresult')->middleware('auth');
Route::post('/findcertificates','PemsController@findcertificates')->name('/findcertificates')->middleware('auth');
Route::get('/showquestion','PemsController@showquestion')->name('/showquestion')->middleware('auth');
Route::post('/qandalive/{examcode}/showonlinequestions/{qid}/showonlinequestion','PemsController@showonlinequestions')->name('/qandalive/{examcode}/showonlinequestions/{qid}/showonlinequestion')->middleware('auth');
Route::get('/selectquestion','PemsController@selectquestion')->name('/selectquestion')->middleware('auth');
Route::post('/selectexam','PemsController@selectexam')->name('/selectexam')->middleware('auth');
Route::post('/selectexamoffline','PemsController@selectexamoffline')->name('/selectexamoffline')->middleware('auth');
Route::post('/selectexamquestionno','PemsController@selectexamquestionno')->name('/selectexamquestionno')->middleware('auth');
Route::post('/selectexamquestionnooffline','PemsController@selectexamquestionnooffline')->name('/selectexamquestionnooffline')->middleware('auth');
Route::get('/journal','PemsController@journal')->name('/journal')->middleware('auth');
Route::get('/pems/journal','PemsController@journal')->name('/pems/journal')->middleware('auth');
Route::post('/pems/getmemberjournal','PemsController@getmemberjournal')->name('/pems/getmemberjournal')->middleware('auth');
Route::any('/pems/journal/{memberid}/showjournal/{resultid}/show','PemsController@getmemberjournalresult')->middleware('auth');

Route::any('/pems/memberadmin','PemsController@showmemberadmin')->name('/pems/memberadmin')->middleware('auth');
Route::any('/pems/memberadminq','PemsController@showmemberadminq')->name('/pems/memberadminq')->middleware('auth');
Route::any('/pems/savenewphone','PemsController@savenewphone')->name('/pems/savenewphone')->middleware('auth');
Route::any('/pems/savenewemail','PemsController@savenewemail')->name('/pems/savenewemail')->middleware('auth');
Route::any('/pems/deleteemail','PemsController@deleteemail')->name('/pems/deleteemail')->middleware('auth');
Route::any('/pems/deletephone','PemsController@deletephone')->name('/pems/deletephone')->middleware('auth');
Route::any('/pems/updateaddress','PemsController@updateaddress')->name('/pems/updateaddress')->middleware('auth');
Route::any('/pems/updateinformation','PemsController@updateinformation')->name('/pems/updateinformation')->middleware('auth');
Route::any('/pems/deletependingmembers','PemsController@deletependingmembers')->name('/pems/deletependingmembers')->middleware('auth');

Route::any('/pems/memberstatus','PemsController@memberstatus')->name('/pems/memberstatus')->middleware('auth');
Route::any('/pems/memberstatusq','PemsController@memberstatusq')->name('/pems/memberstatusq')->middleware('auth');
Route::get('/pems/pendingmembers','PemsController@pendingmembers')->name('/pems/pendingmembers')->middleware('auth');
Route::get('/pems/bulkemail','PemsController@bulkemail')->name('/pems/bulkemail')->middleware('auth');
Route::any('/pems/sendbulkemail','PemsController@sendbulkemail')->name('/pems/sendbulkemail')->middleware('auth');
Route::any('/pems/allresultq','PemsController@allresultq')->name('/pems/allresultq')->middleware('auth');
Route::any('/pems/downloadresult/{id}','PemsController@downloadresult')->name('/pems/downloadresult/{id}')->middleware('auth');
///////////////--------------------------UPLOAD VIDEO-----------------------------------------------------------------
Route::get('/uploadfile','PemsController@showuploadvideo')->middleware('auth');
Route::post('/uploadfile','PemsController@showUploadFile')->middleware('auth');

//Route::get('/pems/qandalive','PemsController@qandalive')->name('/pems/qandalive')->middleware('auth');
Route::get('/pems/qandalive','PemsController@selectquestion')->name('/pems/qandalive')->middleware('auth');
Route::get('/pems/qandaoffline','PemsController@qandaoffline')->name('/pems/qandaoffline')->middleware('auth');
Route::get('/pems/invoicing','PemsController@invoicing')->name('/pems/invoicing')->middleware('auth');
Route::any('/pems/certificate','PemsController@certificate')->name('/pems/certificate')->middleware('auth');
Route::get('/pems/rossusers','PemsController@rossusers')->name('/pems/rossusers')->middleware('auth');
Route::get('/pems/allresult','PemsController@allresult')->name('/pems/allresult')->middleware('auth');


Route::get('pems/questions','PemsController@questions')->middleware('auth');
Route::get('pems/results','PemsController@results')->middleware('auth');
Route::get('pems/certificates','PemsController@certificates')->middleware('auth');
Route::get('pems/mails','PemsController@mails')->middleware('auth');
});


Route::post('/payinvoice', 'MapController@payinvoice')->name('/payinvoice')->middleware('auth');
Route::post('/undopayinvoice', 'MapController@undopayinvoice')->name('/undopayinvoice')->middleware('auth');
Route::post('/payinvoice2', 'MapController@payinvoice2')->name('/payinvoice2')->middleware('auth');
Route::post('/undopayinvoice2', 'MapController@undopayinvoice2')->name('/undopayinvoice2')->middleware('auth');
