...
return [
 ...
 // "from" => array(        "address" => "from@example.com",        "name" => "Example"    ),
  "username" => "6a10923cc18467",
  "password" => "a6c5305cf15dd0",
  ...
  // 'from' => ['address' => 'info@acpaglobal.online', 'name' => 'Director'],
  // 'encryption' => env('MAIL_ENCRYPTION', 'tls'),
  // 'username' => env('seralkhatem332211@gmail.com'),
  // 'password' => env('nmgpfiycywnrzmki'),
  // 'sendmail' => '/usr/sbin/sendmail -bs',
  // 'pretend' => false,
...
// MAIL_PORT=2525
// MAIL_USERNAME=6a10923cc18467
// MAIL_PASSWORD=a6c5305cf15dd0
// MAIL_ENCRYPTION=tls
...
// // "from" => array(        "address" => "from@example.com",        "name" => "Example"    ),
//  "username" => "seralkhatem3210@gmail.com",
// "password" => "Web@Agri2022",
// // "username" => "info@acpaglobal.online",
// // "password" => "P@ssw0rd",
